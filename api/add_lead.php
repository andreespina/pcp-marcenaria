...
if ($data) {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO comercial_leads 
            (cliente_id, cliente_nome, telefone, origem, arquiteto_nome, projetista_responsavel, ambientes, valor_estimado, probabilidade, data_apresentacao, data_inicio_projeto, prazo_projeto_dias, observacao, memorial_descritivo) 
            VALUES (:cid, :nome, :tel, :origem, :arq, :proj, :amb, :valor, :prob, :dt_apres, :dt_ini, :prazo, :obs, :memorial)");
