                    ...
                    <?php foreach ($fornecedores as $f): ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors row-fornecedor">
                            ...
                            <td class="px-6 py-4 font-medium text-gray-600 dark:text-gray-300">
                                <?= !empty($f['cnpj_cpf']) ? htmlspecialchars($f['cnpj_cpf']) : '<span class="italic text-gray-400">Não informado</span>' ?>
                            </td>
                            <td class="px-6 py-4">
                                <p class="font-bold text-gray-800 dark:text-gray-200 uppercase"><?= !empty($f['contato_nome']) ? htmlspecialchars($f['contato_nome']) : '-' ?></p>
                            ...
                            <td class="px-6 py-4 font-bold text-gray-800 dark:text-gray-300">
                                <?= !empty($f['telefone']) ? htmlspecialchars($f['telefone']) : '-' ?>
                            </td>
                            <td class="px-6 py-4 text-center space-x-2">
                                ...
                                <button onclick="deletarFornecedor(<?= $f['id'] ?>)" class="text-red-500 hover:text-red-700 dark:hover:text-red-400 bg-red-50 dark:bg-red-900/20 p-1.5 rounded transition-colors" title="Apagar">
