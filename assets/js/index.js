...
function imprimirFicha(id, cliente, statusAtual, dataLimite, observacao, promob, corte, compras, ferragens, chkResp, medAgen, medData, equipe, dtIni, dtFim, diasUteis, projExec) {
    ...
    <div class="header"><img src="${logoSrc}" alt="Logo Empresa" style="max-width: 150px; height: auto;" onerror="this.style.display='none';"><div style="text-align: right;"><h1 style="margin:0; font-size: 24px;">FICHA DE PRODUÇÃO - PCP</h1><p style="margin:5px 0 0 0; font-size: 14px;">Ordem de Serviço #${id}</p></div></div>
